...
import org.usfirst.frc.team686.lib.sensors.GyroAdapter;
 ...
 * <li>Use the gyro's getAngle() method in your isFinished() method (it will be
 * zero initially and change as the robot rotates).</li>
 * </ul>
 * 
 * <p>
...
// Please do note that the Y gyro may currently be inverted, if so please change
// the value to true on line 185.

public abstract class GyroSubsystem extends Subsystem {

	// NOTE: Several of these constants could be relocated to RobotMap if you
	// want to make them public
	// (I just grew tired of fighting conflicts).

	/**
	 * Type of Gyro hardware that can be used by this subsystem (NOTE: FAKE
	 * always returns 0).
	 */
