...
// Copied from FRC Team 3620, The Average Joes
// https://github.com/FRC3620/FRC3620_2015_AverageJava/blob/master/FRC3620_2015_AverageJava/src/org/usfirst/frc3620/LogTimestamp.java
...
public class LogTimestamp 
{
	...
	{
		if (_timestampString == null) // do a quick check (no overhead from synchronized)
		{ 
